...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $existingIds = DB::table('subscribers')->orderBy('id')->pluck('id')->toArray();
        ...
        $allRows = DB::table('subscribers')->orderBy('id')->get(['id', 'name', 'account_number', 'email', 'phone', 'address', 'created_at', 'updated_at']);
        $insertRows = [];

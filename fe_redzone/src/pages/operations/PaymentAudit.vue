...
<template>
  <div>
    ...
    <VCard><VTable><thead><tr><th>Time (Philippines)</th><th>Payment</th><th>Action</th><th>Staff</th><th>Reason</th><th></th></tr></thead><tbody>
      ...
      <tr v-if="!result.data.length"><td colspan="6" class="pa-5">No matching payment history.</td></tr>

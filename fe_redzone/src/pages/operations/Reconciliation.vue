...
<template>
  <div>
    ...
    <VCard class="mb-6"><VCardTitle>Collector balances · {{ report.date || date }}</VCardTitle>
      ...
      <VTable><thead><tr><th>Collector</th><th>Method</th><th>Payments</th><th>Collected</th><th>Remitted</th><th>Difference</th></tr></thead><tbody>
        ...
        <tr v-if="!report.rows.length"><td colspan="6" class="pa-5">No collections or remittances for this date.</td></tr>
      </tbody></VTable>
    </VCard>
    <VCard><VCardTitle>Remittance history</VCardTitle><VTable><thead><tr><th>Reference</th><th>Collector / method</th><th>Amount</th><th>Recorded by</th><th>Status</th><th></th></tr></thead><tbody>
      ...
      <tr v-if="!report.remittances.length"><td colspan="6" class="pa-5">No remittances recorded.</td></tr>
    </tbody></VTable></VCard>
